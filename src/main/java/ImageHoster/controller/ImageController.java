...
public class ImageController {
    ...
    private Boolean isImageOwner(Image image, HttpSession session) {
        Integer imageOwnerUserId = image.getUser().getId();
        User loggedInUser = (User) session.getAttribute("loggeduser");
        Integer loggedInUserId = loggedInUser.getId();
        return loggedInUserId.equals(imageOwnerUserId);
    }
