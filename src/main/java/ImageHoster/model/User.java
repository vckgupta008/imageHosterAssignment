...
public class User {
    ...
    // then all the records in 'comments' table associated to that particular record in 'users' table will
    // be deleted first and then the record in the 'users' table will be deleted
    //FetchType is EAGER
